          ...
          <div className="bg-cover bg-center w-full h-[800px]">
            ...
            <main className="flex-grow p-8">
              <section className="text-center mb-16">
                ...
                <h2 className='text-2xl font-thin font-serif text-white'># Charles Xavier's School for Gifted Students</h2>
              ...
              <section className="mt-12">
                <h2 className="text-3xl font-semibold text-center text-sky-400 mb-6">College Clubs</h2>
              ...
              <section className="mt-12">
                <h2 className="text-3xl font-semibold text-center text-sky-400 mb-6">Upcoming Events</h2>
